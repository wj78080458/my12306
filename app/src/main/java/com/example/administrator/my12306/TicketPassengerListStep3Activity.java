...
import com.example.administrator.my12306.MyContactActivity;
import com.example.administrator.my12306.MyContactEditActivity;
	...
	class PassengerListTask extends AsyncTask<String, String, Object> {
		...
		protected void onPreExecute() {
			...
			pDialog = ProgressDialog.show(
					TicketPassengerListStep3Activity.this, null, "���ڼ�����...",
					false, true);
		}
